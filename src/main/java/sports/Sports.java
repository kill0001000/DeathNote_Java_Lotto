...
public class Sports {
    ...
    private static boolean compare_sports(Node xml, String[] oneSports) {
        ...
        if (redSame[1] < 680 || redSame[1] > 764)
            return true;
        if (redSame[2] < 180 || redSame[2] > 260)
            return true;
        if (redSame[3] < 17 || redSame[3] > 31)
            return true;
        if (redSame[4] > 2)
            return true;
        if (redSame[5] > 0)
        ...
        if (blueSame[0] < 1150 || blueSame[0] > 1250)
            return true;
        if (blueSame[1] < 480 || blueSame[1] > 580)
            return true;
        if (blueSame[2] < 16 || blueSame[2] > 36)
            return true;

        if (allSame[0] < 467 || allSame[0] > 585)
            return true;
        if (allSame[1] < 690 || allSame[1] > 780)
            return true;
        if (allSame[2] < 336 || allSame[2] > 420)
            return true;
        if (allSame[3] < 71 || allSame[3] > 125)
            return true;
        if (allSame[4] < 4 || allSame[4] > 17)
            return true;
        if (allSame[5] > 2)
            return true;
        if (allSame[6] > 0)
